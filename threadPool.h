#ifndef __NETPRO__THREADPOOL__H
...
public:
    threadPool(int minThread, int maxThread, int queueMax)
        ...
        queueFront(0), queueBack(0), queueSize(0), minThreadNum(minThread), 
        maxThreadNum(maxThread), liveThreadNum(minThread), busyThreadNum(0), waitExitNum(0), 
        shutdown(false) {
